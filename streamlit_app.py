...
def girisi_kontrol_et() -> bool:
    ...
    # oturuma degil ADRESE bagliyoruz: tarayici adresi korudugu icin baglanti
        ...
        if hmac.compare_digest(sifre, dogru):
            ...
            if _jeton:
                try:
                    ...
                    pass
            # st.rerun() KULLANMIYORUZ. Rerun, sunucuyla fazladan bir tur daha
            # konusmak demek; kurumsal vekil sunucularin ardinda bu tur
            # kopabiliyor ve ekran bos kaliyordu. Form gonderimi zaten yeni bir
            # calisma baslattigi icin dogrudan True donup ayni calismada
